...
void robotTask(void *arg) {
  ...
  robot.armMoveSmooth(3.5, 7.2, 10, 200);
  ...
  robot.armMoveSmooth(1.5, robot.getLastScannerPoint().distance * 0.0393701 + 0.2, 40, 500, true);
  ...
  robot.setArmPosition(8.3, 6.5, 45);
  ...
  robot.locatePet(SCAN_RIGHT, 250);

  robot.armMoveSmooth(1, robot.getLastScannerPoint().distance * 0.0393701 + 0.3, 40, 500, true);
  ...
  robot.setBaseSpeed(0.0);
  robot.armMoveSmooth(3.5, 8, 30, 300);
  robot.setBaseSpeed(0.4);
  ...
  robot.delay(10);
  robot.clawHalfOpen();
  robot.setArmPosition(0, 0, -5, true);
  robot.armMoveSmooth(9.6, 8, 30, 300);
  robot.flaccid();
  
  robot.startScanning();
  delay(1000);

  robot.armMoveSmooth(1, robot.getLastScannerPoint().distance * 0.0393701 + 0.5, 40, 500, true);
  ...
  robot.armMoveSmooth(12, 6, 30, 600);
