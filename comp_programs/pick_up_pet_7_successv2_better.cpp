...
void robotTask(void *arg) {
  ...
  robot.delay(1200);
  robot.armMoveSmooth(9, 11, 30, 300);
  robot.delay(200);
  robot.releasePet();
  robot.delay(300);
  robot.flaccid();
  ...
  robot.armMoveSmooth(10, 6.5 + dist, 40, 500);
  ...
  robot.setBaseSpeed(-1);
  robot.delay(20);
  while (robot.getDistanceTravelled() > -0.07) {
    robot.delay(1);
  }
  ...
  robot.armMoveSmooth(12, 6.4, 30, 400);

  robot.delay(20);

  robot.setArmPosition(12, 6.4, 0);
  ...
  robot.delay(100);
  robot.armMoveSmooth(9.2, 4.5, 30, 400);
  ...
  robot.armMoveSmooth(3.8, 6.3, 30, 500);
