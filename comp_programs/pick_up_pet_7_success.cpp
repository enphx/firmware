...
void robotTask(void *arg) {
  ...
  float dist1 = robot.getLastScannerPoint().distance * 0.0393701 + 0.3;

  robot.armMoveSmooth(10, 6.5 + dist1, 40, 500);

  robot.grabPet();
  robot.delay(600);
  

  robot.armMoveSmooth(15, 6.5 + dist1, 30, 300);
  robot.armMoveSmooth(15, 6, 30, 600);

  robot.setArmPosition(15, 6, -10);
  robot.delay(200);
  robot.setArmPosition(15, 6, -10);
  robot.delay(300);
  ...
  robot.setBaseSpeed(-1);
  robot.delay(20);
  while (robot.getDistanceTravelled() > -0.1) {
    robot.delay(1);
  }
  ...
  robot.startScanning();
  robot.delay(100);
  float dist = robot.getLastLastScannerPoint().distance * 0.0393701 + 0.3;
