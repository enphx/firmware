...
void robotTask(void *arg) {
  ...
  robot.resetDistanceTravelled();
  delay(300);
  robot.setArmPosition(13, 5.5, 0);
  while (robot.getDistanceTravelled() < 0.5) {
    robot.delay(1);
  }

  // Line up debris traverse.
  ...
  robot.armMoveSmooth(5.3, 5.7, 40, 350);
  ...
  robot.setBaseSpeed(-1);
  robot.delay(20);
  while (robot.getDistanceTravelled() > -0.076) {
    robot.delay(1);
  }
  ...
  robot.locatePet(SCAN_RIGHT, 260, 0.3);
  robot.startScanning();
  robot.delay(100);
  dist = robot.getLastLastScannerPoint().distance * 0.0393701 + 0.3;

  robot.armMoveSmooth(6.8, 6.5, 20, 300);
  robot.armMoveSmooth(6.8, 6.5 + dist, 30, 600);
  ...
  // Put pet 7 in the basket.
  robot.armMoveSmooth(8, 6.5 + dist, 30, 300);
  robot.armMoveSmooth(12.3, 5.5, 30, 400);

  robot.setArmPosition(12.3, 5.5, 0);
  ...
  robot.setArmPosition(12, 6.4, 90);
  ...
  // Go over tape until we see pet 6.
  robot.setTapeFollowing(false);
  robot.setBaseSpeed(1.0);


  robot.armMoveSmooth(5, 6.3, 30, 500);
  ...
  // Scan and grab pet 6.
  robot.setScannerThreshold(220, false);
  while (!robot.scannerThresholdTripped()) {
    robot.delay(1);
  }
  ...
  // Put pet 6 in the basket.
  robot.armMoveSmooth(10.8, 5.5, 30, 400);

  robot.setArmPosition(10.8, 5.5, 0.0);
  ...
  robot.releasePet();
  robot.delay(400);
  robot.armMoveSmooth(12, 6.4, 10, 400);
  robot.armMoveSmooth(15, 8, 30, 200);


  // Move to scan for pet 5.
  robot.setArmPosition(15, 8, -80);


  // Find tape and follow
  robot.setBaseSpeed(1);
  robot.turnAngle(-10);
  robot.findTape();
  robot.setBaseSpeed(0);
  ...
  // Scan for pet 5.
  robot.startScanning();
  robot.armMoveSmooth(4.6, 6.3, 30, 300);
  ...
  // Carry pet 5 in arm.
  robot.armMoveSmooth(15, 8, 30, 600);
  robot.delay(80);
  robot.setArmPosition(15, 8, 0);
  ...
  while(robot.getDistanceTravelled() < 0.25) {
    robot.delay(1);
  }
  ...
  robot.setArmPosition(7.1, 14.5, 0);
